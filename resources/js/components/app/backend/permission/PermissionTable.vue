                        ...
                        <tbody>
                            ...
                            <tr v-for="permission in permissions.data" :key="permission.id" v-else>
                               ...
                               <vs-avatar :color="getColor()">
                                ...
                                <td><vs-button  permission="button" @click="editItem(permission)"> Edit</vs-button> |  <vs-button permission="button"  @click="deleteItem(permission)">Delete</vs-button></td>
                            </tr>
                        </tbody>
                        </table>
                    </div>
    ...
    alldeleteItems(){
          Swal.fire({
              ...
              if (result.isConfirmed) {
                ...
                axios.post("/api/management/remove-all/permissions",form_data).then((res) => {
